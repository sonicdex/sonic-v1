...
import { idlFactory } from './landingpage_frontend.did.js';
export { idlFactory } from './landingpage_frontend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.LANDINGPAGE_FRONTEND_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./landingpage_frontend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the landingpage_frontend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./landingpage_frontend.did.js")._SERVICE>}
 */
export const landingpage_frontend = createActor(canisterId);
