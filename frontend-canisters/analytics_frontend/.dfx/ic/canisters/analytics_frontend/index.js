...
import { idlFactory } from './analytics_frontend.did.js';
export { idlFactory } from './analytics_frontend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.ANALYTICS_FRONTEND_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./analytics_frontend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the analytics_frontend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./analytics_frontend.did.js")._SERVICE>}
 */
export const analytics_frontend = createActor(canisterId);
